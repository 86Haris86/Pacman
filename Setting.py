...
from Afbeeldingen import donkergroen, lichtgroen , corner_LB , corner_LBOVEN , corner_RB_copy , corner_RBOVEN_copy_2 , separatie_boven , separatie , wite_lijn_L , wite_lijn_R
...
if maze2 == gebruikte_maze:
    # Waar de speler mag bewegen in de maze
    toegelaten_posities_speler = [0,2,3,4,5,7,8,9,10]
    # Waar de vijand mag bewegen in de maze
    toegelaten_posities_vijand = []
    deur_van_spoken = []
    # speler
